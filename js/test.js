...
//   console.log(composeMessage.call(order));
//   messages.push(composeMessage.call(order));
// }
...
// // тут мы вызываем функцию в контексте каждого объекта (orders[i]) и передаем позицию + 1
//
// -----------------------------------------------------------------------------------------
// APPLY
